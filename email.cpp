...
{QString status;
    Smtp* smtp = new Smtp("buyeragentreal@gmail.com", "12300azer", "smtp.gmail.com", 465);

    smtp->sendMail("buyeragentreal@gmail.com", ui->recipient_2->text() , ui->subjectLineEdit_2->text() ,ui->message_2->toPlainText());
